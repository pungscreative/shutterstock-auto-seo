...
# CSS Styling - Fluid Gradient Background, Liquid Glassmorphism, & Gradient Chunky Title
st.markdown("""
<style>
    ...
    /* Background Fluid Bergradasi Pastel ala Referensi */
    .stApp {
    ...
    /* Elemen Fluid & Liquid Gradient Blobs */
    .stApp::before {
        content: '';
        position: absolute;
        top: -80px;
    ...
    /* Setiap Kolom Dibungkus Efek Kaca Transparan (Liquid Glass UI Kit) */
    [data-testid="column"] {
